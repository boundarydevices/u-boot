...
#define GP_LED_BLUE1		IMX_GPIO_NR(4, 6)
		IOMUX_PAD_CTRL(KEY_COL0__GPIO4_IO06, WEAK_PULLUP_OUTPUT),
#define GP_LED_GREEN1	IMX_GPIO_NR(4, 7)
		IOMUX_PAD_CTRL(KEY_ROW0__GPIO4_IO07, WEAK_PULLUP_OUTPUT),
#define GP_LED_RED1	IMX_GPIO_NR(4, 8)
		IOMUX_PAD_CTRL(KEY_COL1__GPIO4_IO08, WEAK_PULLUP_OUTPUT),

#define GP_LED_BLUE2	IMX_GPIO_NR(4, 9)
		IOMUX_PAD_CTRL(KEY_ROW1__GPIO4_IO09, WEAK_PULLUP_OUTPUT),
#define GP_LED_GREEN2	IMX_GPIO_NR(1, 0)
		IOMUX_PAD_CTRL(GPIO_0__GPIO1_IO00, WEAK_PULLUP_OUTPUT),
#define GP_LED_RED2	IMX_GPIO_NR(1, 3)
		IOMUX_PAD_CTRL(GPIO_3__GPIO1_IO03, WEAK_PULLUP_OUTPUT),

#define GP_LED_BLUE3	IMX_GPIO_NR(1, 7)
		IOMUX_PAD_CTRL(GPIO_7__GPIO1_IO07, WEAK_PULLUP_OUTPUT),
#ifdef CONFIG_REV_AG
#define GP_LED_GREEN3	IMX_GPIO_NR(1, 8)
		IOMUX_PAD_CTRL(GPIO_8__GPIO1_IO08, WEAK_PULLUP_OUTPUT),
#endif
#define GP_LED_RED3	IMX_GPIO_NR(6, 11)
		IOMUX_PAD_CTRL(NANDF_CS0__GPIO6_IO11, WEAK_PULLUP_OUTPUT),
};
