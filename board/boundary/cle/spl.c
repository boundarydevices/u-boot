...
static int power_init_boundary(void)
{
	int ret;
	unsigned char buf[4];
...
#define LDO2_STBY	0x8f
...
#if 0	/* This is the default, so skip */
	/* soc */
	buf[0] = 0x40;	/* (.80-.4)*160=.40*160=64=0x40  64/160+.4=.80  */
	...
	buf[0] = 0x9b;	/* VSELECT_EN */
	ret = i2c_write(PF8100, LDO2_CONFIG2, 1, buf, 1);
#endif
