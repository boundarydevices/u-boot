...
static struct dram_cfg_param lpddr4_ddrc_cfg[] = {
	...
	{ DDRC_INIT4(0), (LPDDR4_MR3 << 16) | 0x20000 },
...
static struct dram_cfg_param lpddr4_fsp0_cfg[] = {
	...
	{ 0x54018, 0x0 },
	{ 0x54019, 0x2dd4 },
	{ 0x5401a, (((LPDDR4_RON) << 3) | LPDDR4_MR3) },
	...
	{ 0x5401f, 0x2dd4 },
	{ 0x54020, (((LPDDR4_RON) << 3) | LPDDR4_MR3) },
	...
	{ 0x54031, 0x0 },
	{ 0x54032, 0xd400 },
	{ 0x54033, ((((LPDDR4_RON) << 3) | LPDDR4_MR3) << 8) | 0x2d },
	...
	{ 0x54038, 0xd400 },
	{ 0x54039, ((((LPDDR4_RON) << 3) | LPDDR4_MR3) << 8) | 0x2d },
