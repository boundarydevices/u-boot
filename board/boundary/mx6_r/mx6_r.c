...
#define WEAK_PULLUP		(PAD_CTL_HYS | PAD_CTL_PUS_100K_UP | PAD_CTL_SPEED_LOW | PAD_CTL_DSE_40ohm)
#define WEAK_PULLDN		(PAD_CTL_HYS | PAD_CTL_PUS_100K_DOWN | PAD_CTL_SPEED_LOW | PAD_CTL_DSE_40ohm)
...
static iomux_v3_cfg_t const button_pads[] = {
	/* GPIO_KEYS - J4  */
	NEW_PAD_CTRL(MX6_PAD_EIM_DA0__GPIO_3_0, WEAK_PULLUP),	/* pin 1 - back */
	NEW_PAD_CTRL(MX6_PAD_EIM_DA1__GPIO_3_1, WEAK_PULLUP),	/* pin 2 - Home(left) */
	NEW_PAD_CTRL(MX6_PAD_EIM_DA2__GPIO_3_2, WEAK_PULLUP),	/* pin 3 - Menu */
	NEW_PAD_CTRL(MX6_PAD_EIM_DA3__GPIO_3_3, WEAK_PULLUP),	/* pin 4 - Down */
	NEW_PAD_CTRL(MX6_PAD_GPIO_18__GPIO_7_13, WEAK_PULLUP),	/* pin 5 - up */
	...
	NEW_PAD_CTRL(MX6_PAD_SD3_DAT4__GPIO_7_1, WEAK_PULLDN),	/* pin 9 inverted, Main power off request */
...
static iomux_v3_cfg_t const init_pads[] = {
	...
	/* USB otg power */
	NEW_PAD_CTRL(MX6_PAD_EIM_D22__GPIO_3_22, OUTPUT_40OHM),
	/* Main power */
	NEW_PAD_CTRL(MX6_PAD_SD1_DAT0__GPIO_1_16, OUTPUT_40OHM),
	/* Mipi Camera Reset */
	NEW_PAD_CTRL(MX6_PAD_CSI0_DATA_EN__GPIO_5_20, OUTPUT_40OHM),
	/* Mipi Powerdown */
