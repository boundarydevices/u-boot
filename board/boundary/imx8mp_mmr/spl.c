...
static iomux_v3_cfg_t const init_pads[] = {
	...
	IOMUX_PAD_CTRL(SD1_STROBE__USDHC1_STROBE, USDHC_PAD_CTRL),
...
#define GP_USDHC2_WP		IMX_GPIO_NR(2, 20)
	IOMUX_PAD_CTRL(SD2_WP__USDHC2_WP, 0x1d0),
#define GP_USDHC2_CD		IMX_GPIO_NR(2, 12)
	IOMUX_PAD_CTRL(SD2_CD_B__GPIO2_IO12, 0x1d0),

};

struct fsl_esdhc_cfg board_usdhc_cfg[] = {
	{.esdhc_base = USDHC1_BASE_ADDR, .bus_width = 8, .gp_reset = GP_EMMC_RESET},
	{.esdhc_base = USDHC2_BASE_ADDR, .bus_width = 4, .gp_cd = GP_USDHC2_CD, .wp_enable = 1},
};
