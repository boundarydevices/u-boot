...
static void enable_ldb0(struct display_info_t const *dev)
{
	...
	gpio_direction_output(CONFIG_BDMX6_LVDS1_PWM, 0);
}
...
static void enable_ldb1(struct display_info_t const *dev)
{
	...
	reg |= 4;
	writel(reg, &iomux->gpr[2]);
	gpio_direction_output(CONFIG_BDMX6_LVDS0_PWM, 0);
	gpio_direction_output(CONFIG_BDMX6_LVDS1_PWM, 1);
}
...
static void setup_display(void)
{
	...
	gpio_direction_input(CONFIG_BDMX6_LVDS0_PWM);
	gpio_direction_input(CONFIG_BDMX6_LVDS1_PWM);
	gpio_direction_input(CONFIG_BDMX6_RGB_PWM);
