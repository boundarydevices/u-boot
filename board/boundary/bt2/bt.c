...
#define GP_REG_WLAN_EN	IMX_GPIO_NR(6, 7)
	...
	/* UART4 - GPS - cannot use simultaneously with UART4 -J3 */
	IOMUX_PAD_CTRL(CSI0_DAT12__UART4_TX_DATA, WEAK_PULLUP),
	IOMUX_PAD_CTRL(CSI0_DAT13__UART4_RX_DATA, WEAK_PULLUP),
...
#endif
	IOMUX_PAD_CTRL(KEY_COL0__GPIO4_IO06, OUTPUT_40OHM),
