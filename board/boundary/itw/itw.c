...
static const iomux_v3_cfg_t init_pads[] = {
	...
	/* AUDMUX - J2 */
	IOMUX_PAD_CTRL(SD2_DAT0__AUD4_RXD, AUD_PAD_CTRL),	/* pin 3 */
	IOMUX_PAD_CTRL(SD2_CMD__AUD4_RXC, AUD_PAD_CTRL),	/* pin 2 */
	IOMUX_PAD_CTRL(SD2_CLK__AUD4_RXFS, AUD_PAD_CTRL),	/* pin 1 */

	/* Backlight LVDS1 */
#define GP_LVDS1_PWR_EN		IMX_GPIO_NR(7, 13)
	IOMUX_PAD_CTRL(GPIO_18__GPIO7_IO13, WEAK_PULLDN),	/* 1 enable Power, J6 pin 20,22 */
#define GP_LVDS1_12V_5V_BL_SELECT IMX_GPIO_NR(1, 9)
	IOMUX_PAD_CTRL(GPIO_9__GPIO1_IO09, WEAK_PULLDN),	/* 0:5V, 1:12V, J6 pin 20,22 */

	/* Backlight LVDS2 */
#define GP_LVDS2_PWR_EN		IMX_GPIO_NR(4, 5)
	IOMUX_PAD_CTRL(GPIO_19__GPIO4_IO05, WEAK_PULLDN),	/* 1 enable Power, J10 pin 2,4 */
#define GP_LVDS2_12V_5V_BL_SELECT IMX_GPIO_NR(1, 7)
...
#define GP_CAN1_STANDBY		IMX_GPIO_NR(4, 6)
	IOMUX_PAD_CTRL(KEY_COL0__GPIO4_IO06, WEAK_PULLUP_OUTPUT),

	/* FLEXCAN2 */
	IOMUX_PAD_CTRL(KEY_COL4__FLEXCAN2_TX, WEAK_PULLUP),
	IOMUX_PAD_CTRL(KEY_ROW4__FLEXCAN2_RX, WEAK_PULLUP),
#define GP_CAN2_STANDBY		IMX_GPIO_NR(4, 7)
	IOMUX_PAD_CTRL(KEY_ROW0__GPIO4_IO07, WEAK_PULLUP_OUTPUT),

	/* gpio - keys */
#define GP_GPIOKEY_RESET_REQUEST IMX_GPIO_NR(3, 31)
	IOMUX_PAD_CTRL(EIM_D31__GPIO3_IO31, WEAK_PULLUP),
#define GP_GPIOKEY_J24_OC	IMX_GPIO_NR(5, 15)
	IOMUX_PAD_CTRL(DISP0_DAT21__GPIO5_IO15, WEAK_PULLUP),

	/* gpio - leds */
#define GP_GPIOLEDS_GREEN	IMX_GPIO_NR(3, 12)
	IOMUX_PAD_CTRL(EIM_DA12__GPIO3_IO12, WEAK_PULLUP_OUTPUT),
#define GP_GPIOLEDS_RED	IMX_GPIO_NR(3, 6)
	IOMUX_PAD_CTRL(EIM_DA6__GPIO3_IO06, WEAK_PULLUP_OUTPUT),
#define GP_GPIOLEDS_SATA	IMX_GPIO_NR(2, 17)	/* Active low */
	IOMUX_PAD_CTRL(EIM_A21__GPIO2_IO17, WEAK_PULLUP_OUTPUT),
#define GP_GPIOLEDS_USB3	IMX_GPIO_NR(2, 22)	/* Active high */
...
#define GP_RESET2	IMX_GPIO_NR(5, 27)
	IOMUX_PAD_CTRL(CSI0_DAT9__GPIO5_IO27, WEAK_PULLDN),
#define GP_RESET3	IMX_GPIO_NR(5, 28)
	IOMUX_PAD_CTRL(CSI0_DAT10__GPIO5_IO28, WEAK_PULLDN),
#define GP_RESET4	IMX_GPIO_NR(5, 29)
	IOMUX_PAD_CTRL(CSI0_DAT11__GPIO5_IO29, WEAK_PULLDN),
#define GP_RESET5	IMX_GPIO_NR(5, 30)
	IOMUX_PAD_CTRL(CSI0_DAT12__GPIO5_IO30, WEAK_PULLDN),

#define GP_12V_EN	IMX_GPIO_NR(4, 20)
	IOMUX_PAD_CTRL(DI0_PIN4__GPIO4_IO20, WEAK_PULLDN),
#define GP_J24_EN	IMX_GPIO_NR(5, 16)
	IOMUX_PAD_CTRL(DISP0_DAT22__GPIO5_IO16, WEAK_PULLDN),
...
#define GP_SGTL5000_HP_MUTE	IMX_GPIO_NR(2, 0)              /* Low is muted */
	IOMUX_PAD_CTRL(NANDF_D0__GPIO2_IO00, WEAK_PULLDN),
#define GPIRQ_SGTL5000_MIC_DET	IMX_GPIO_NR(1, 24)
	IOMUX_PAD_CTRL(ENET_RX_ER__GPIO1_IO24, WEAK_PULLUP),	/* J14 pin 3 */
#define GPIRQ_SGTL5000_SPKR_DET	IMX_GPIO_NR(4, 8)
	IOMUX_PAD_CTRL(KEY_COL1__GPIO4_IO08, WEAK_PULLUP),	/* J8 pin 4 */

	/* i2c2 ov5640 Camera controls, J23 */
...
#define GP_OV5640_MIPI_RESET	IMX_GPIO_NR(2, 5)
	...
	/* i2c3 AR1020 touchscreen controller */
#define GPIRQ_AR1020		IMX_GPIO_NR(7, 1)
	IOMUX_PAD_CTRL(SD3_DAT4__GPIO7_IO01, WEAK_PULLDN),

	/* PCIe */
#define GP_PCIE_RESET		IMX_GPIO_NR(7, 8)
	IOMUX_PAD_CTRL(SD3_RST__GPIO7_IO08, WEAK_PULLDN),
#define GP_PCIE_DISABLE		IMX_GPIO_NR(1, 4)
	IOMUX_PAD_CTRL(GPIO_4__GPIO1_IO04, WEAK_PULLDN),

	/* PWM1 - Backlight on LVDS1 connector: J6, pin 28, LVDS2 J10, pin 6 */
#define GP_BACKLIGHT_LVDS	IMX_GPIO_NR(1, 21)
	IOMUX_PAD_CTRL(SD1_DAT3__GPIO1_IO21, WEAK_PULLDN),

	/* PWM2 - Buzzer */
#define GP_BUZZER		IMX_GPIO_NR(1, 18)
	IOMUX_PAD_CTRL(SD1_DAT2__GPIO1_IO19, WEAK_PULLDN),

	/* PWM3 - mipi camera, J23, pin 10 */
...
#define GP_RGB_MIRROR_V		IMX_GPIO_NR(2, 27)
	IOMUX_PAD_CTRL(EIM_LBA__GPIO2_IO27, WEAK_PULLDN),	/* DI0 display up/down mirror */
...
static const iomux_v3_cfg_t rgb_pads[] = {
	...
	IOMUX_PAD_CTRL(DI0_PIN15__IPU1_DI0_PIN15, RGB_PAD_CTRL),	/* DE */
...
static struct i2c_pads_info i2c_pads[] = {
	...
	/* I2C2 Camera(MIPI), HDMI, PCIe */
	I2C_PADS_INFO_ENTRY(I2C2, KEY_COL3, 4, 12, KEY_ROW3, 4, 13, I2C_PAD_CTRL),
	/* I2C3, AR1020 Touch, PCA9540B mux to LVDS J6,  LVDS J10 */
...
static void setup_iomux_enet(void)
{
	...
	gpio_direction_output(GP_AR8035_AD1, 0);
...
static const unsigned short gpios_out_low[] = {
	...
	GP_PCIE_DISABLE,
	GP_BACKLIGHT_LVDS,
	GP_LVDS1_12V_5V_BL_SELECT,
	GP_LVDS2_12V_5V_BL_SELECT,
	GP_BUZZER,
	GP_BACKLIGHT_RGB,
	GP_RGB_12V_5V_BL_SELECT,
	GP_REG_USBOTG,
...
static const unsigned short gpios_in[] = {
	...
	GP_TP91,
	GP_TP94,
	GPIRQ_SGTL5000_MIC_DET,
	GPIRQ_SGTL5000_SPKR_DET,
	GPIRQ_RTC_RV4162,
	GPIRQ_AR1020,
	GP_LVDS1_LINK1,
	GP_LVDS1_LINK2,
