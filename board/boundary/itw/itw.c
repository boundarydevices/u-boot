...
#define GP_CAN2_STANDBY		IMX_GPIO_NR(4, 7)
	...
	/* gpio - keys */
#define GP_RESET_REQUEST	IMX_GPIO_NR(3, 31)
	IOMUX_PAD_CTRL(EIM_D31__GPIO3_IO31, WEAK_PULLUP),
#define GP_J24_OC	IMX_GPIO_NR(5, 15)
	IOMUX_PAD_CTRL(DISP0_DAT21__GPIO5_IO15, WEAK_PULLUP),

	/* gpio - leds */
#define GP_LED_USB3	IMX_GPIO_NR(2, 22)	/* Active high */
	IOMUX_PAD_CTRL(EIM_A16__GPIO2_IO22, WEAK_PULLDN_OUTPUT),
#define GP_LED_SATA	IMX_GPIO_NR(2, 17)	/* Active low */
...
#define GPIRQ_SPKR_DET		IMX_GPIO_NR(1, 24)
...
#define GP_LVDS1_LINK6		IMX_GPIO_NR(2, 3)
