...
iomux_v3_cfg_t const enet_pads1[] = {
	...
	MX6_PAD_RGMII_RXC__GPIO_6_30		| MUX_PAD_CTRL(ENET_PAD_CTRL),
	MX6_PAD_RGMII_RD0__GPIO_6_25		| MUX_PAD_CTRL(ENET_PAD_CTRL),
	MX6_PAD_RGMII_RD1__GPIO_6_27		| MUX_PAD_CTRL(ENET_PAD_CTRL),
	MX6_PAD_RGMII_RD2__GPIO_6_28		| MUX_PAD_CTRL(ENET_PAD_CTRL),
	MX6_PAD_RGMII_RD3__GPIO_6_29		| MUX_PAD_CTRL(ENET_PAD_CTRL),
	MX6_PAD_RGMII_RX_CTL__GPIO_6_24		| MUX_PAD_CTRL(ENET_PAD_CTRL),
...
void set_strap_pins(unsigned strap)
{
	int i = 0;
