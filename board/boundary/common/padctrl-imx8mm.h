...
#define WEAK_PULLUP		(PAD_CTL_DSE6 | PAD_CTL_FSEL2 | PAD_CTL_HYS | PAD_CTL_PUE)
#define WEAK_PULLUP_OUTPUT	(PAD_CTL_DSE6 | PAD_CTL_FSEL2 | PAD_CTL_PUE)
#define WEAK_PULLDN_OUTPUT	(PAD_CTL_DSE6 | PAD_CTL_FSEL2)	/* Cannot pull down */
