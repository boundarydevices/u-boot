...
#elif GP_RGMII_PHY_RESET == IMX_GPIO_NR(1, 3)
	IOMUX_PAD_CTRL(GPIO1_IO03__GPIO1_IO3, ATHEROS_RESET_PINCTRL),
#elif GP_RGMII_PHY_RESET == IMX_GPIO_NR(2, 10)
	IOMUX_PAD_CTRL(SD1_RESET_B__GPIO2_IO10, ATHEROS_RESET_PINCTRL),
#elif GP_RGMII_PHY_RESET == IMX_GPIO_NR(4, 28)
	IOMUX_PAD_CTRL(SAI3_RXFS__GPIO4_IO28, ATHEROS_RESET_PINCTRL),
#endif
...
static const iomux_v3_cfg_t enet_ksz9021_gpio_pads[] = {
	IOMUX_PAD_CTRL(ENET_RD0__GPIO1_IO26, PULL_GP(STRAP_KSZ9021, 0)),
	IOMUX_PAD_CTRL(ENET_RD1__GPIO1_IO27, PULL_GP(STRAP_KSZ9021, 1)),
	IOMUX_PAD_CTRL(ENET_RD2__GPIO1_IO28, PULL_GP(STRAP_KSZ9021, 2)),
	IOMUX_PAD_CTRL(ENET_RD3__GPIO1_IO29, PULL_GP(STRAP_KSZ9021, 3)),
	IOMUX_PAD_CTRL(ENET_RX_CTL__GPIO1_IO24, PULL_GP(STRAP_KSZ9021, 4)),
	IOMUX_PAD_CTRL(ENET_RXC__GPIO1_IO25, PULL_GP(STRAP_KSZ9021, 5)),
};

static const iomux_v3_cfg_t enet_ksz9021_pads[] = {
	IOMUX_PAD_CTRL(ENET_RD0__ENET1_RGMII_RD0, PULL_ENET(STRAP_KSZ9021, 0)),
	IOMUX_PAD_CTRL(ENET_RD1__ENET1_RGMII_RD1, PULL_ENET(STRAP_KSZ9021, 1)),
	IOMUX_PAD_CTRL(ENET_RD2__ENET1_RGMII_RD2, PULL_ENET(STRAP_KSZ9021, 2)),
	IOMUX_PAD_CTRL(ENET_RD3__ENET1_RGMII_RD3, PULL_ENET(STRAP_KSZ9021, 3)),
	IOMUX_PAD_CTRL(ENET_RX_CTL__ENET1_RGMII_RX_CTL, PULL_ENET(STRAP_KSZ9021, 4)),
	IOMUX_PAD_CTRL(ENET_RXC__ENET1_RGMII_RXC, PULL_ENET(STRAP_KSZ9021, 5)),
};
#endif
