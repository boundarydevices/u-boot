...
#define GP_PHY_REF_CLK	IMX_GPIO_NR(1, 23)	/* 41 LED_MODE,	23 CLK_25M no strap */
...
static const iomux_v3_cfg_t enet_ar8035_gpio_pads[] = {
	...
	IOMUX_PAD_CTRL(ENET_REF_CLK__GPIO1_IO23, PULL_GP(STRAP_AR8035, 6)),
};
...
#define STRAP_KSZ9021	(0x5f | ((CONFIG_FEC_MXC_PHYADDR & 4) ? 0x20 : 0))
...
static const iomux_v3_cfg_t enet_ksz9021_gpio_pads[] = {
	...
	IOMUX_PAD_CTRL(RGMII_RXC__GPIO6_IO30, PULL_GP(STRAP_KSZ9021, 5)),
	IOMUX_PAD_CTRL(ENET_REF_CLK__GPIO1_IO23, PULL_GP(STRAP_KSZ9021, 6)),
};
