...
#ifndef STRAP_AR8035
#define STRAP_AR8035	((0x28 | (CONFIG_FEC_MXC_PHYADDR & 3)) | ((0x28 | (CONFIG_FEC_MXC_PHYADDR2 & 3)) << 6))
#endif
...
#define STRAP_KSZ9021	((STRAP_KSZ_BASE | ((CONFIG_FEC_MXC_KSZ_PHYADDR & 4) ? 0x20 : 0)) | ((STRAP_KSZ_BASE | ((CONFIG_FEC_MXC_KSZ_PHYADDR2 & 4) ? 0x20 : 0)) << 6))
...
static const iomux_v3_cfg_t enet_ksz9021_gpio_pads[] = {
	...
	IOMUX_PAD_CTRL(RGMII2_RD0__GPIO5_IO_12, PULL_GP(STRAP_KSZ9021, 6)),
	IOMUX_PAD_CTRL(RGMII2_RD1__GPIO5_IO_13, PULL_GP(STRAP_KSZ9021, 7)),
	IOMUX_PAD_CTRL(RGMII2_RD2__GPIO5_IO_14, PULL_GP(STRAP_KSZ9021, 8)),
	IOMUX_PAD_CTRL(RGMII2_RD3__GPIO5_IO_15, PULL_GP(STRAP_KSZ9021, 9)),
	IOMUX_PAD_CTRL(RGMII2_RX_CTL__GPIO5_IO_16, PULL_GP(STRAP_KSZ9021, 10)),
	IOMUX_PAD_CTRL(RGMII2_RXC__GPIO5_IO_17, PULL_GP(STRAP_KSZ9021, 11)),
};
...
static const iomux_v3_cfg_t enet_ksz9021_pads[] = {
	...
	IOMUX_PAD_CTRL(RGMII2_RD0__ENET2_RX_DATA_0, PULL_ENET(STRAP_KSZ9021, 6)),
	IOMUX_PAD_CTRL(RGMII2_RD1__ENET2_RX_DATA_1, PULL_ENET(STRAP_KSZ9021, 7)),
	IOMUX_PAD_CTRL(RGMII2_RD2__ENET2_RX_DATA_2, PULL_ENET(STRAP_KSZ9021, 8)),
	IOMUX_PAD_CTRL(RGMII2_RD3__ENET2_RX_DATA_3, PULL_ENET(STRAP_KSZ9021, 9)),
	IOMUX_PAD_CTRL(RGMII2_RX_CTL__ENET2_RX_EN, PULL_ENET(STRAP_KSZ9021, 10)),
	IOMUX_PAD_CTRL(RGMII2_RXC__ENET2_RX_CLK, PULL_ENET(STRAP_KSZ9021, 11)),
};
#endif
