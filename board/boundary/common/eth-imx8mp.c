...
#define STRAP_KSZ9021	AR_STRAP_KSZ9021 | ((AR_STRAP_KSZ9021) << 6)
#define EQOS_BIT		6
#else
...
#ifdef CONFIG_FEC_MXC
	IOMUX_PAD_CTRL(ECSPI1_MISO__GPIO5_IO08, WEAK_PULLUP_OUTPUT),
...
#endif
#ifdef CONFIG_DWC_ETH_QOS
	IOMUX_PAD_CTRL(NAND_READY_B__GPIO3_IO16, WEAK_PULLUP_OUTPUT),
	IOMUX_PAD_CTRL(ENET_RD0__GPIO1_IO26, PULL_GP(STRAP_KSZ9021, 0 + EQOS_BIT)),
	IOMUX_PAD_CTRL(ENET_RD1__GPIO1_IO27, PULL_GP(STRAP_KSZ9021, 1 + EQOS_BIT)),
	IOMUX_PAD_CTRL(ENET_RD2__GPIO1_IO28, PULL_GP(STRAP_KSZ9021, 2 + EQOS_BIT)),
	IOMUX_PAD_CTRL(ENET_RD3__GPIO1_IO29, PULL_GP(STRAP_KSZ9021, 3 + EQOS_BIT)),
	IOMUX_PAD_CTRL(ENET_RX_CTL__GPIO1_IO24, PULL_GP(STRAP_KSZ9021, 4 + EQOS_BIT)),
	IOMUX_PAD_CTRL(ENET_RXC__GPIO1_IO25, PULL_GP(STRAP_KSZ9021, 5 + EQOS_BIT)),
#endif
};
...
#endif
#ifdef CONFIG_DWC_ETH_QOS
	IOMUX_PAD_CTRL(ENET_RD0__ENET_QOS_RGMII_RD0, PULL_ENET(STRAP_KSZ9021, 0 + EQOS_BIT)),
	IOMUX_PAD_CTRL(ENET_RD1__ENET_QOS_RGMII_RD1, PULL_ENET(STRAP_KSZ9021, 1 + EQOS_BIT)),
	IOMUX_PAD_CTRL(ENET_RD2__ENET_QOS_RGMII_RD2, PULL_ENET(STRAP_KSZ9021, 2 + EQOS_BIT)),
	IOMUX_PAD_CTRL(ENET_RD3__ENET_QOS_RGMII_RD3, PULL_ENET(STRAP_KSZ9021, 3 + EQOS_BIT)),
	IOMUX_PAD_CTRL(ENET_RX_CTL__ENET_QOS_RGMII_RX_CTL, PULL_ENET(STRAP_KSZ9021, 4 + EQOS_BIT)),
	IOMUX_PAD_CTRL(ENET_RXC__CCM_ENET_QOS_CLOCK_GENERATE_RX_CLK, PULL_ENET(STRAP_KSZ9021, 5 + EQOS_BIT)),
#endif
};
#endif
