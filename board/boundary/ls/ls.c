...
#define GP_DISP_DATA_OUT	IMX_GPIO_NR(5, 18)
...
#define GP_DISP_DATA_IN		IMX_GPIO_NR(5, 29)
...
#ifdef CONFIG_NEW_REV
#define GP_I2C3_FLASH_EN	IMX_GPIO_NR(2, 31)
	IOMUX_PAD_CTRL(EIM_EB3__GPIO2_IO31, WEAK_PULLDN_OUTPUT),
#else
#define GP_I2C3_FLASH_EN	IMX_GPIO_NR(3, 16)
