...
#define GP_J11_POWER_EN		IMX_GPIO_NR(7, 3)
	NEW_PAD_CTRL(MX6PAD(SD3_CLK__GPIO7_IO03), PADCFG_FLOAT_IRQ),	/* power on J11 pin 3 */
...
#define GP_KL04_SWD_CLK	IMX_GPIO_NR(1, 0)
	NEW_PAD_CTRL(MX6PAD(GPIO_0__GPIO1_IO00), WEAK_PULLUP),	/* SWD_CLK */
...
#define GP_KL04_RESET	IMX_GPIO_NR(5, 20)
	NEW_PAD_CTRL(MX6PAD(CSI0_DATA_EN__GPIO5_IO20), WEAK_PULLUP),
#define GP_KL04_PROGRAM	IMX_GPIO_NR(5, 22)
	NEW_PAD_CTRL(MX6PAD(CSI0_DAT4__GPIO5_IO22), WEAK_PULLUP),
