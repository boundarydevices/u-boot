...
#define GP_TC358867_EN		IMX_GPIO_NR(5, 0)
...
static const struct display_info_t displays[] = {
	...
	VD_DMT050WVNXCMI(MIPI, fbp_detect_i2c, fbp_bus_gp(3, GP_TC358867_EN, 0, 30), fbp_addr_gp(0x2f, 0, 6, 0), FBP_SPI_LCD, FBTS_GOODIX),
