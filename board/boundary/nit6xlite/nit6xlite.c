...
#define WEAK_PULLDN	(PAD_CTL_PKE | PAD_CTL_PUE |		\
	PAD_CTL_PUS_100K_DOWN | PAD_CTL_SPEED_MED |		\
	PAD_CTL_DSE_40ohm | PAD_CTL_HYS |			\
	PAD_CTL_SRE_SLOW)
...
#define GP_LED_GREEN	IMX_GPIO_NR(1, 2)
	IOMUX_PAD_CTRL(GPIO_2__GPIO1_IO02, PAD_CTL_DSE_240ohm),
#define GP_LED_RED	IMX_GPIO_NR(1, 3)
        IOMUX_PAD_CTRL(GPIO_3__GPIO1_IO03, PAD_CTL_DSE_240ohm),
#define GP_J46_PIN2	IMX_GPIO_NR(1, 7)
        IOMUX_PAD_CTRL(GPIO_7__GPIO1_IO07, PAD_CTL_DSE_240ohm),
#define GP_J46_PIN3	IMX_GPIO_NR(1, 8)
