...
#ifndef __IMX8MM_NITROGEN_SMARC_H
#define __IMX8MM_NITROGEN_SMARC_H
...
#define PHYS_SDRAM_SIZE			SZ_1G /* Minimum */
...
#ifndef BD_CONSOLE
#if CFG_MXC_UART_BASE == UART2_BASE_ADDR
#define BD_CONSOLE	"ttymxc1"
#elif CFG_MXC_UART_BASE == UART1_BASE_ADDR
...
#define CFG_EXTRA_ENV_SETTINGS          \
	...
	"uboot_defconfig=imx8mm_nitrogen_smarc_2gr0\0" \
