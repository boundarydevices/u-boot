...
#define FBF_DMT050WVNXCMI	(FBF_MODE_SKIP_EOT | FBF_MODE_VIDEO | FBF_MODE_VIDEO_BURST | FBF_MIPI_CMDS | FBF_DSI_LANES_4 | FBF_PINCTRL | FBF_ENABLE_GPIOS_DTB)
...
{\
	...
	.mode	= {\
		...
		.xres		= 480,\
		.yres		= 854,\
		.pixclock	= 1000000000000ULL/((480+40+40+8)*(854+40+40+1)*60),\
		.left_margin	= 40,\
		.right_margin	= 40,\
		.upper_margin	= 40,\
		.lower_margin	= 40,\
