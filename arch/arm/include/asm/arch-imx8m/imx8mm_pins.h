...
enum {
	...
	IMX8MM_PAD_UART1_RXD__UART1_RX                                 =  IOMUX_PAD(0x049C, 0x0234, 0, 0x04F4, 0, 0),
	IMX8MM_PAD_UART1_RXD__UART1_TX                                 =  IOMUX_PAD(0x049C, 0x0234, 0, 0x0000, 0, 0),
	...
	IMX8MM_PAD_UART1_TXD__UART1_TX                                 =  IOMUX_PAD(0x04A0, 0x0238, 0, 0x0000, 0, 0),
	IMX8MM_PAD_UART1_TXD__UART1_RX                                 =  IOMUX_PAD(0x04A0, 0x0238, 0, 0x04F4, 1, 0),
	...
	IMX8MM_PAD_UART2_RXD__UART2_RX                                 =  IOMUX_PAD(0x04A4, 0x023C, 0, 0x04FC, 0, 0),
	IMX8MM_PAD_UART2_RXD__UART2_TX                                 =  IOMUX_PAD(0x04A4, 0x023C, 0, 0x0000, 0, 0),
	...
	IMX8MM_PAD_UART2_TXD__UART2_TX                                 =  IOMUX_PAD(0x04A8, 0x0240, 0, 0x0000, 0, 0),
	IMX8MM_PAD_UART2_TXD__UART2_RX                                 =  IOMUX_PAD(0x04A8, 0x0240, 0, 0x04FC, 1, 0),
	...
	IMX8MM_PAD_UART3_RXD__UART3_RX                                 =  IOMUX_PAD(0x04AC, 0x0244, 0, 0x0504, 2, 0),
	IMX8MM_PAD_UART3_RXD__UART3_TX                                 =  IOMUX_PAD(0x04AC, 0x0244, 0, 0x0000, 0, 0),
