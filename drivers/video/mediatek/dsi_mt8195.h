...
struct dsi_regs {
	...
	u8 reserved6[16]; /* 0x120~0x12C */
	u32 dsi_vm_cmd_con;
	u32 dsi_vm_cmd_data0;
	u32 dsi_vm_cmd_data4;
	u32 dsi_vm_cmd_data8;
	u32 dsi_vm_cmd_datac;
	u8 reserved7[32]; /* 0x144~0x160 */
	u32 dsi_state_dbg7; /* 0x164 */
	u8 reserved8[16]; /* 0x168~0x174 */
	u32 dsi_self_pat_con0; /* 0x178 */
	u32 dsi_self_pat_con1; /* 0x17C */
	u8 reserved9[16]; /* 0x180~0x18C */
	u32 dsi_force_commit;  /* 0x190 */
	u8 reserved10[108]; /* 0x194~0x1FC */
	u32 dsi_cmdq[128]; /* 0x200~ */
};
