...
#define MTK_DSI_MAX_WIDTH 1200
#define MTK_DSI_MAX_HEIGHT 1920
...
#define DSI_REG_READ(addr) readl(addr)
#define DSI_REG_WRITE(addr, val) writel(val, addr)
#define DSI_REG_SET_BITS(addr, val) setbits_le32(addr, val)
#define DSI_REG_CLR_BITS(addr, val) clrbits_le32(addr, val)
#define DSI_REG_CLRSET_BITS(addr, clear, val) clrsetbits_le32(addr, clear, val)

#define NS_TO_CYCLE(n, c) ((n) / (c))
#define ALIGN_TO(x, n)  ROUND(x, n)
